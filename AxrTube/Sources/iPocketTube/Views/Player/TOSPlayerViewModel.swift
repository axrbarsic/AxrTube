...
final class TOSPlayerViewModel: NSObject {
    ...
    func pauseWebPlaybackForSystemAudioEvent() {
        ...
        Task {
            ...
            CFNotificationCenterPostNotification(
                ...
                CFNotificationName("com.void.ipockettube.tosplayer.pausedAllMedia" as CFString),
                nil, nil, true
            )
        }
    ...
    private func loadEmbed(videoId: String, startTime: Double) {
        ...
        CFNotificationCenterPostNotification(
            CFNotificationCenterGetDarwinNotifyCenter(),
            CFNotificationName("com.void.ipockettube.tosplayer.loadstarted" as CFString),
            nil, nil, true
        )
...
private final class TOSNavigationDelegate: NSObject, WKNavigationDelegate {
    ...
    func webView(_ webView: WKWebView, didCommit navigation: WKNavigation!) {
        ...
        CFNotificationCenterPostNotification(
            CFNotificationCenterGetDarwinNotifyCenter(),
            CFNotificationName("com.void.ipockettube.tosplayer.navfinished" as CFString),
            nil, nil, true
        )
