...
private let spikeLog = Logger(subsystem: "com.void.ipockettube.app", category: "ShortsSpike")
    ...
    func handleScriptMessage(_ body: String, frameInfo: WKFrameInfo) {
        ...
        case "ready":
            ...
            CFNotificationCenterPostNotification(
                ...
                CFNotificationName("com.void.ipockettube.shortsspike.ready" as CFString),
                nil, nil, true
            )
            Task { [weak self] in
                ...
                await MainActor.run {
                    ...
                    CFNotificationCenterPostNotification(
                        CFNotificationCenterGetDarwinNotifyCenter(),
                        CFNotificationName("com.void.ipockettube.shortsspike.windowclosed" as CFString),
                        nil, nil, true
                    )
                }
            }
        ...
        case "error":
            ...
            CFNotificationCenterPostNotification(
                CFNotificationCenterGetDarwinNotifyCenter(),
                CFNotificationName("com.void.ipockettube.shortsspike.error" as CFString),
                nil, nil, true
            )
