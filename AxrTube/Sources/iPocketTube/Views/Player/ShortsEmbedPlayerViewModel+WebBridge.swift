...
private let shortsLog = Logger(subsystem: "com.void.ipockettube.app", category: "ShortsPlayer")
    ...
    func handleScriptMessage(_ body: String, frameInfo: WKFrameInfo) {
        ...
        case "ping":
            ...
            CFNotificationCenterPostNotification(
                ...
                CFNotificationName("com.void.ipockettube.shortsplayer.bridge" as CFString),
                nil, nil, true
            )
        ...
        case "ready":
            ...
            CFNotificationCenterPostNotification(
                CFNotificationCenterGetDarwinNotifyCenter(),
                CFNotificationName("com.void.ipockettube.shortsplayer.ready" as CFString),
                nil, nil, true
            )
        ...
        case "stateChange":
            ...
            if playerState == .paused {
                ...
                CFNotificationCenterPostNotification(
                    CFNotificationCenterGetDarwinNotifyCenter(),
                    CFNotificationName("com.void.ipockettube.shortsplayer.paused" as CFString),
                    nil, nil, true
                )
            } else {
            ...
            if playerState == .playing {
                CFNotificationCenterPostNotification(
                    CFNotificationCenterGetDarwinNotifyCenter(),
                    CFNotificationName("com.void.ipockettube.shortsplayer.playing" as CFString),
                    nil, nil, true
                )
            }
        ...
        case "tick":
            ...
            if !hasReceivedFirstTick {
                ...
                CFNotificationCenterPostNotification(
                    CFNotificationCenterGetDarwinNotifyCenter(),
                    CFNotificationName("com.void.ipockettube.shortsplayer.tickstarted" as CFString),
                    nil, nil, true
                )
            }
            ...
            if newState != playerState {
                ...
                CFNotificationCenterPostNotification(
                    CFNotificationCenterGetDarwinNotifyCenter(),
                    CFNotificationName("com.void.ipockettube.shortsplayer.state.\(s)" as CFString),
                    nil, nil, true
                )
            }
        ...
        case "error":
            ...
            CFNotificationCenterPostNotification(
                CFNotificationCenterGetDarwinNotifyCenter(),
                CFNotificationName("com.void.ipockettube.shortsplayer.error.\(code)" as CFString),
                nil, nil, true
            )
