...
- **Matrix UI и haptics.** Системная, тёмная и светлая темы переключаются без перезапуска. Семантическая тактильность различает выбор, транспорт, успех, предупреждение, ошибку и разрушительное подтверждение, не вибрируя при прокрутке или пассивном прогрессе.
