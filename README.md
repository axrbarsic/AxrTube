...
- **Progressive audio и офлайн.** Совместимый поток начинает играть до завершения скачивания; те же подтверждённые диапазоны становятся локальным ресурсом. На карточке текущего трека строится форма волны из реальных аудиоданных локального файла, по ней можно перематывать запись. Позиция каждого ролика сохраняется отдельно и восстанавливается перед следующим запуском воспроизведения. Есть аудио/видео, прогресс, отмена, повтор, удаление, лимит хранилища и время загрузки.
