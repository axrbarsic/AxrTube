...
final class ShortsEmbedPlayerViewModel: NSObject {
    ...
    func loadShort(video: Video) {
        ...
        CFNotificationCenterPostNotification(
            ...
            CFNotificationName("com.void.ipockettube.shortsplayer.loadstarted" as CFString),
            nil, nil, true
        )
    ...
    func pauseWebPlaybackForSystemAudioEvent() {
        ...
        pauseAllMediaTask = Task { [weak self] in
            ...
            CFNotificationCenterPostNotification(
                CFNotificationCenterGetDarwinNotifyCenter(),
                CFNotificationName("com.void.ipockettube.shortsplayer.pausedAllMedia" as CFString),
                nil, nil, true
            )
        }
