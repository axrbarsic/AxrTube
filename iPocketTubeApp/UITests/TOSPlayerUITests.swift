...
final class TOSPlayerUITests: XCTestCase {
    ...
    func testTOSPlayerPlaysFirstHomeVideo() throws {
        ...
        let loadStartNote  = XCTDarwinNotificationExpectation(notificationName: "com.void.ipockettube.tosplayer.loadstarted")
        let navNote        = XCTDarwinNotificationExpectation(notificationName: "com.void.ipockettube.tosplayer.navfinished")
        let bridgeNote     = XCTDarwinNotificationExpectation(notificationName: "com.void.ipockettube.tosplayer.bridge")
        let readyNote      = XCTDarwinNotificationExpectation(notificationName: "com.void.ipockettube.tosplayer.ready")
        let tickStartNote  = XCTDarwinNotificationExpectation(notificationName: "com.void.ipockettube.tosplayer.tickstarted")
        let playingNote    = XCTDarwinNotificationExpectation(notificationName: "com.void.ipockettube.tosplayer.playing")
        // State-transition diagnostics (via tick handler): observe which states are hit
        let stateBuffNote  = XCTDarwinNotificationExpectation(notificationName: "com.void.ipockettube.tosplayer.state.3")
        let stateCuedNote  = XCTDarwinNotificationExpectation(notificationName: "com.void.ipockettube.tosplayer.state.5")
        let statePauseNote = XCTDarwinNotificationExpectation(notificationName: "com.void.ipockettube.tosplayer.state.2")
        let stateEndedNote = XCTDarwinNotificationExpectation(notificationName: "com.void.ipockettube.tosplayer.state.0")
    ...
    func testTOSPlayerStopsAudioOnDismiss() throws {
        ...
        let pausedNote = XCTDarwinNotificationExpectation(notificationName: "com.void.ipockettube.tosplayer.pausedAllMedia")
        ...
        XCTAssertEqual(
            ...
            "com.void.ipockettube.tosplayer.pausedAllMedia never fired after dismissal — " +
    ...
    /// (via the `com.void.ipockettube.tosplayer.sponsorskip` Darwin notification — see
    ...
    func testTOSPlayerAutoSkipsSponsorSegment() throws {
        ...
        let readyNote   = XCTDarwinNotificationExpectation(notificationName: "com.void.ipockettube.tosplayer.ready")
        let playingNote = XCTDarwinNotificationExpectation(notificationName: "com.void.ipockettube.tosplayer.playing")
        let skipNote    = XCTDarwinNotificationExpectation(notificationName: "com.void.ipockettube.tosplayer.sponsorskip")
        ...
        XCTAssertEqual(
            ...
            "com.void.ipockettube.tosplayer.sponsorskip never fired — TOS player did not " +
