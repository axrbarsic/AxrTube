# История изменений iPocketTube

Здесь перечислены подтверждённые изменения iPocketTube.
...
7. **Публичное описание:** README, ограничения, история изменений и GitHub metadata синхронизированы с фактически проверенным состоянием iPocketTube без готовых IPA и неподтверждённых обещаний.
