...
| Matrix UI, карточки и навигация | `RootView`, `SmartTubeDarkTheme`, общие card policies |
| SponsorBlock и DeArrow | соответствующие сервисы SmartTubeIOSCore |
...
Проект является модифицированным fork [milika/SmartTubeIOS](https://github.com/milika/SmartTubeIOS) и распространяется по [GPL-3.0](../LICENSE).
